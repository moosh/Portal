...
int Queue::scheduleFunction(queuedFunction func, const char * id, unsigned long initialWait, unsigned long recur, int message, void* ctx)
{
	int rv = 0;
...
int Queue::removeAll(void)
{
	queueItem ignored;
 	while (_queueGetTop(ignored) == 0) { }
	return 0;
}
